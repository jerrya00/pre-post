%include "u:\thesis\master thesis\simulation\simulation_macro_1128_sim_r.sas"; 
%library(mm = 11, dd = 28);
...
proc sgplot data = plot_&nsub._&mech._&waist_hip.;
    ...
    yaxis label = "Power" min = .35 max = .8 minor labelattrs = (size = 16);
    series x = mis y = mixed_ / markers lineattrs = (color = black pattern = 1 thickness = 2) markerattrs = (color = black symbol = circle) legendlabel = "Mixed Model, AA" name = "Mixed Model, AA";
    series x = mis y = mixed_cc / markers lineattrs = (color = black pattern = 41 thickness = 2) markerattrs = (color = black symbol = diamond) legendlabel = "Mixed Model, CC" name = "Mixed Model, CC";
    series x = mis y = ancova_ / markers lineattrs = (color = black pattern = 5 thickness = 2) markerattrs = (color = black symbol = circlefilled)legendlabel = "ANCOVA, MI" name = "ANCOVA, MI";
    series x = mis y = ancova_cc / markers lineattrs = (color = black pattern = 34 thickness = 2) markerattrs = (color = black symbol = diamondfilled)legendlabel = "ANCOVA, CC" name = "ANCOVA, CC";
...
proc sgplot data = plot_&nsub._&mech._&waist_hip.;
	xaxis label = "Percentage of Missing Data" type = discrete labelattrs = (size = 16);
    yaxis label = "Power" min = .6 max = 1 minor labelattrs = (size = 16);
    series x = mis y = mixed_ / markers lineattrs = (color = black pattern = 1 thickness = 2) markerattrs = (color = black symbol = circle) legendlabel = "Mixed Model, AA" name = "Mixed Model, AA";
    series x = mis y = mixed_cc / markers lineattrs = (color = black pattern = 41 thickness = 2) markerattrs = (color = black symbol = diamond) legendlabel = "Mixed Model, CC" name = "Mixed Model, CC";
    series x = mis y = ancova_ / markers lineattrs = (color = black pattern = 5 thickness = 2) markerattrs = (color = black symbol = circlefilled)legendlabel = "ANCOVA, MI" name = "ANCOVA, MI";
    series x = mis y = ancova_cc / markers lineattrs = (color = black pattern = 34 thickness = 2) markerattrs = (color = black symbol = diamondfilled)legendlabel = "ANCOVA, CC" name = "ANCOVA, CC";
