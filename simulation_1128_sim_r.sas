...
*library for the BePHIT data;
libname data "U:\Thesis\Master Thesis\data";
...
%data20(libname = sim, dsname = sim20, seed = 513471, nreps = 500, nsub = 35, 
      b0 = 17.9464, b1 = -0.8111, b2 = -2, b3 = 0, b4 = -1, b5 = 0, var_b = 3.0689, var_e = 1.0047); *set b4 = -1 for power 11/28/2015;
